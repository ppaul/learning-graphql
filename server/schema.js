...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    rockets: {
      ...
      resolve(parent, args) {
        return axios.get('https://api.spacexdata.com/v3/rockets').then(response => response.data);
      }
    },
    rocket: {
      type: RocketType,
      ...
      resolve(parent, args) {
        return axios.get(`https://api.spacexdata.com/v3/rockets/${args.id}`).then(response => response.data);
      }
    }
  }
});
